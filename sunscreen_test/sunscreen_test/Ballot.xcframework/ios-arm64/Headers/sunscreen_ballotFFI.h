...
RustBuffer ffi_sunscreen_ballot_rustbuffer_from_bytes(ForeignBytes bytes, RustCallStatus *_Nonnull out_status
);
void ffi_sunscreen_ballot_rustbuffer_free(RustBuffer buf, RustCallStatus *_Nonnull out_status
);
